...
punctutation = [\.,\.\!\;\'\"\?]
vowels = [aeiouAEIOU].[a-zA-Z0-9.]


%%

//{vowels} = { System.out.printf(" Vowels [%s] at line no: %d and column no: %d", yytext(), yyline + 1, yycolumn); }
...
{punctutation} { System.out.printf(" found punctutation dble %s at line no: %d and column no: %d\n", yytext(), yyline, yycolumn); }
